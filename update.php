       ...
       <span>title</span><br>
         ...
         <input type="text" name = "titre" value="<?php echo $row["titre"]; ?>" > <br> <br>
           <span>Author</span><br>
              ...
              <span>image </span>
           <div class="">
         <input type="file"  name = "images" style="height:35px" style="width:300px;" value="<?php echo $row["images"]; ?>"> <br> <br>
         <span>prix </span>
           <div class="">
         <input type="text"  name = "prix" style="width:300px;" value="<?php echo $row["prix"]; ?>">
    </div> <br>
  <span> quatité au stock</span>  <br>
        <input type="text"  name = "quantite" value="<?php echo $row["quantite"]; ?>"> <br> <br>
  <span>date d'achat</span>  <br>
      <input type="date" name="date_achat" style="width:300px;" value="<?php echo $row["date_achat"]; ?>"> <br> <br>
         <div>
    <span>Date du publication</span><br> 
    <input type="date" style="width:300px;" class="form-control"  name="date_de_publication" 
